...
CREATE TABLE champion_bet (
                              ...
                              semifinalist1_team_id UUID,
                              semifinalist2_team_id UUID,
                              semifinalist3_team_id UUID,
                              semifinalist4_team_id UUID,
                              bet_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE group_winner_bet (
                                  ...
                                  first_place_team_id UUID NOT NULL,
                                  second_place_team_id UUID NOT NULL,
                                  bet_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                  points_earned INTEGER NOT NULL DEFAULT 0,
